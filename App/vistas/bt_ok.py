...
<VerArboles>:
    GridLayout:
        ...
        Spinner:
            ...
            text: 'CLIMA'
            background_color :37/255.,99/255.,237/255.,1
            values: 'TROPICAL', 'SECO', 'TEMPLADO', 'CONTINENTAL', 'ALTA MONTAÑA', 'SELVA TROPICAL', 'TROPICAL MONZONICO', 'ADAPTABLE', 'ARIDO', 'SEMIARIDO', 'MEDITERRANEO', 'OCEANICO', 'TEMPLADO SUBHUMEDO', 'CALIDO'
            on_text:
